...
public class AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnimation, final View startView, View endView,
        ...
        ScaleAnimation translaetScaleAnimation = new ScaleAnimation(1.0f, 0.0f, 1.0f, 0.0f, toX, toY);
        translaetScaleAnimation.setStartOffset(animationDurution);
        translaetScaleAnimation.setDuration(ANIMATION_DURUTION);

        animationSet.addAnimation(startScaleAnimation);
        animationSet.addAnimation(translateAnimation);
        animationSet.addAnimation(translaetScaleAnimation);
